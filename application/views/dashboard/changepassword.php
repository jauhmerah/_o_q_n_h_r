                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input class="form-control" name="currentpassword" placeholder="Please enter your current password.">
                                            <!--input type="text" name="username" placeholder="Please enter your username." class="form-username form-control" id="username">-->
                                        </div>

                                        <div class="form-group">
                                            <label>NEW Password</label>
                                            <input class="form-control" name="newpassword" placeholder="Please enter your new password.">
                                            <!--input type="text" name="email" placeholder="Please enter your email address." class="form-email form-control" id="email">-->
                                        </div>

                                         <div class="form-group">
                                            <label>CONFIRM Password</label>
                                            <input class="form-control" name="confirmpassword" placeholder="Please confirm your new password.">
                                            <!--input type="text" name="email" placeholder="Please enter your email address." class="form-email form-control" id="email">-->
                                        </div>
                      ...
                      <div class="col-sm-4">  <br> <br>
                           <input type="submit" class="btn btn-warning" style="background-color:#2DAADF" value="Submit"></input>
                      </div>
