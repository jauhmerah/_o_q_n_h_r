...
<html lang="en">
    ...
    <head>
		...
		<title>Souq Anshar | Reset Password</title>
                    ...
                    <div class="row" >
                        <div class="col-sm-6 col-sm-offset-3 form-box"  >
                            ...
                            <div class="form-bottom">
			                    ...
			                    <form role="form" action="<?php echo site_url('User_Authentication/user_login_process');?>" method="post" class="login-form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="password" placeholder="Re-type password..." class="form-password form-control" id="password" required>
                                    </div>
