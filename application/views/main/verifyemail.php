                    ...
                    <div class="col-md-5 col-sm-8 col-xs-8">
                        <div class="header-half header-call">
                          <p>
                                ...
                                <span><i class="icon-mail"></i>adminsouqanshar.com</span>
                            </p> 
                        </div>
                    </div>
         ...
         <div class="slider-area">
            <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
                  ...
                  <div class="item"><img src="<?php echo base_url();?>assets/img/slider-image-5.jpg" alt="Mirror Edge"><div style="margin-top:-480px; color:#fff; font-style:gisha; font-size:25px; font-weight:600; text-align:center;" class = "col-md-8 col-md-offset-2" >
