...
<head>
    ...
    <title>Souq Anshar | Checkout</title>
    ...
    <link rel="apple-touch-icon-precomposed" href="<?php echo base_url();?>assets/miza-cart/apple-touch-icon-57-precomposed.png">
</head><!--/head-->
...
<nav class="navbar navbar-default">
          <div class="container" style="background:#000;">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              ...
              <ul class="main-nav nav navbar-nav navbar-right">
              	<br>
                <li class="wow fadeInDown" data-wow-delay="0s"><a class="active" href="<?php echo site_url('main');?>">Home</a></li>
					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								...
								<li><a href=""><i class="fa fa-envelope"></i> Souq Anshar.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="index.html"><img src="images/home/miza.png" alt="" /></a>
						</div>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			...
			<div class="container">
				<div class="row">
					<p class="pull-left">Copyright © Souq Anshar.com All rights reserved.</p>
