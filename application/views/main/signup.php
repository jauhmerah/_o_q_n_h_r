...
<html lang="en">
  <head>
    ...
    <!-- Bootstrap core CSS -->
    <link  rel="stylesheet" href="<?php echo base_url();?>assets/miza/css/bootstrap.min.css">
    
     <link  rel="stylesheet" href="<?php echo base_url();?>assets/miza/css/theme.css">
    <link  rel="stylesheet" href="<?php echo base_url();?>assets/miza/css/bootstrap-reset.css">
    <!--external css-->
    ...
    <link rel="stylesheet"  type='text/css' href="<?php echo base_url();?>'http://fonts.googleapis.com/css?family=Lato'">
