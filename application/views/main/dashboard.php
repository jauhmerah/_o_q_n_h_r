...
<head>
    ...
    <title>Souq Anshar|Dashboard</title>
    <!-- Bootstrap Styles-->
...
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header" style= "background:#000000; padding-left:100px; padding-bottom:20px;" ><img src= "<?php echo base_url();?>assets/anot/dashboard/assets/img/logo1.png" width= "230px" height="70px" >
                <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".sidebar-collapse">
                   <br> <span class="sr-only">Toggle navigation</span></br>
        ...
        <div id="page-wrapper">
            <div id="page-inner">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-header" style="font-style:gisha;"">
