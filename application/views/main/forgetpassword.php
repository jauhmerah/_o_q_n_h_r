...
<html lang="en">
    <head>
		...
		<title>Souq Anshar | Forget Password</title>
        	...
        	<div class="modal-dialog">
        		<div class="modal-content">
        			...
        			<div class="modal-header">
        				...
        				<h3 class="modal-title" id="modal-register-label">Forget Password</h3>
        			...
        			<div class="modal-body">
	                    ...
	                    <form role="form" action="<?php echo site_url('main/page/success_verify/4'); ?>" method="post" class="registration-form">
	                        ...
	                        <button type="button" class="btn" name = "butang" id = "butang">Send</button>
	                    </form>
