...
<body>
	<div class="main">
		<div class="header" >
			<h1>Welcome to Secure Checkout!</h1>
		</div>
			...
			<form>
				<ul class="left-form">
					...
					<br>
					<input type="submit" onclick="myFunction()" value="Proceed">
						<div class="clear"> </div>
				</ul>
				<ul class="right-form">
					...
					<div>
						...
						<h4>I forgot my Password!</h4-->
							<input style="margin-left:70px;" type="submit" onclick="myFunction()" value="Sign Up" >
					</div>
					<div class="clear"> </div>
				</ul>
				<div class="clear"> </div>
